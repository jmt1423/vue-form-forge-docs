---
title: Installation
description: A guide to install the form builder
---

## Prerequisites

> Please note this is not an NPM package and cannot be installed as such. The CLI is the official way to get up
> and running with the form builder.
...
This command will install the required dependencies and add the form builder to your `src/components/form-builder`
directory.

## 2. Tailwind setup and CSS theme
...
### **Update your main `style.css` file**

> The theme variables below are not technically required, however they are highly recommended even if you plan
> on changing the theme and styles yourself.
...
### **Create a `formkit.theme.ts` file**

> This file is very long but contains the styling for all elements that could be rendered
> by the formkit library. You can either copy and paste the file from the gist I created below,
> or setup your own theme at https://themes.formkit.com/
